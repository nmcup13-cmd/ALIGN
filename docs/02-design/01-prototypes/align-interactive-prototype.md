...
- **(ใหม่ — มือถือ) สมัครสมาชิก (M10)**: กรอกฟอร์มสมัครสมาชิกของอาจารย์ผู้สอนได้จริง (ชื่อ-นามสกุล, อีเมลสถาบัน, สังกัด, รหัสผ่าน+ยืนยัน) พร้อม validation แบบเรียลไทม์ (รูปแบบอีเมล, รหัสผ่านตรงกัน, ปุ่มสมัครสมาชิก disable จนกรอกครบ) กดสมัครแล้วเปลี่ยนเป็นหน้าจอยืนยันว่าสถานะ "รออนุมัติ" ทันที (AB-24)
...
> **ข้อสมมติที่ต้องยืนยัน**: ฟิลด์ในฟอร์มสมัครสมาชิก (`M-SignUp.dc.html`) — ชื่อ-นามสกุล, อีเมลสถาบัน, สังกัด/ภาควิชา, รหัสผ่าน — เป็นข้อเสนอของผู้ออกแบบ เพราะ AB-24 ในสเปคยังไม่ได้กำหนดรายการฟิลด์ที่แน่นอน หากมีข้อกำหนดจริงจากมหาวิทยาลัย (เช่น ต้องใช้รหัสพนักงาน/SSO) ต้องปรับ mockup นี้ตาม
