...
ต้นแบบทั้งหมดในโฟลเดอร์นี้ยึด [[../../../DESIGN.md|DESIGN.md]] เป็น source of truth ด้าน visual/UX (สี, ตัวอักษร, spacing, component, UX Rules) เสมอ
...
- [[align-connected-mobile-prototype|Prototype: Connected Mobile Walkthrough — ALIGN (ทั้ง 2 บทบาท)]] — single-page app ไฟล์เดียวจบ ทุกหน้าจอเชื่อมกันจริง ใช้ทดสอบ flow ต่อเนื่องกับอาจารย์จริงได้
